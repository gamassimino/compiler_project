...
public class Divided extends Expression{
  ...
  public Divided(Expression a_left, Expression a_right, Integer a_line, Integer a_column){
    line = a_line;
    column = a_column;
    left = a_left;
    right = a_right;
  ...
  public Type getType(){
    return left.getType().toString().equals(right.getType().toString())? left.getType(): new Type("Divided.WrongType.Exception");
  }
