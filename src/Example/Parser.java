...
/** CUP v0.11b 20140611 (SVN rev 31) generated parser.
  * @version Tue Aug 30 13:03:11 ART 2016
  */
public class Parser extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = 
    ...
    "\003\000\002\006\002\000\002\003\005\000\002\003\004" +
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\024\000\010\003\004\025\010\034\006\001\002\000" +
    "\004\021\026\001\002\000\012\002\uffff\003\uffff\025\uffff" +
    "\034\uffff\001\002\000\014\021\ufffb\022\ufffb\023\ufffb\024" +
    "\ufffb\026\ufffb\001\002\000\012\002\025\003\004\025\010" +
    "\034\006\001\002\000\006\025\010\034\006\001\002\000" +
    "\012\021\ufffe\022\013\023\014\024\015\001\002\000\004" +
    "\021\021\001\002\000\006\025\010\034\006\001\002\000" +
    "\006\025\010\034\006\001\002\000\006\025\010\034\006" +
    "\001\002\000\014\021\ufff8\022\ufff8\023\ufff8\024\ufff8\026" +
    "\ufff8\001\002\000\014\021\ufff9\022\ufff9\023\ufff9\024\015" +
    "\026\ufff9\001\002\000\014\021\ufffa\022\ufffa\023\014\024" +
    "\015\026\ufffa\001\002\000\012\002\ufffd\003\ufffd\025\ufffd" +
    "\034\ufffd\001\002\000\012\022\013\023\014\024\015\026" +
    "\023\001\002\000\014\021\ufff7\022\ufff7\023\ufff7\024\ufff7" +
    "\026\ufff7\001\002\000\012\002\001\003\001\025\001\034" +
    "\001\001\002\000\004\002\000\001\002\000\012\002\ufffc" +
    "\003\ufffc\025\ufffc\034\ufffc\001\002" });
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\024\000\010\002\006\003\004\004\010\001\001\000" +
    "\002\001\001\000\002\001\001\000\002\001\001\000\006" +
    "\003\023\004\010\001\001\000\004\004\021\001\001\000" +
    "\004\006\011\001\001\000\002\001\001\000\004\004\017" +
 ...
 System.out.println(" = "+e.eval()+";"); 
		...
		Expr e = (Expr)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		 RESULT = e; 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 11: // expr_bool ::= BOOL 
            {
              Booleans RESULT =null;
		Location bxleft = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$Parser$stack.peek()).xleft;
		Location bxright = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$Parser$stack.peek()).xright;
		Boolean b = (Boolean)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT= new Booleans.BoolConst(nxleft,b,nxright); 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("expr_bool",3, ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 12: // expr_bool ::= expr_bool AND expr_bool 
            {
              Booleans RESULT =null;
		Location lxleft = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)).xleft;
		Location lxright = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)).xright;
		Booleans l = (Booleans)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-2)).value;
		Location rxleft = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$Parser$stack.peek()).xleft;
		Location rxright = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$Parser$stack.peek()).xright;
		Booleans r = (Booleans)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = new Booleans.BoolExpr(l,sym.AND,r); 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("expr_bool",3, ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 13: // expr_bool ::= expr_bool OR expr_bool 
            {
              Booleans RESULT =null;
		Location lxleft = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)).xleft;
		Location lxright = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)).xright;
		...
		Location rxright = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$Parser$stack.peek()).xright;
		Booleans r = (Booleans)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = new Booleans.BoolExpr(l,sym.OR,r); 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("expr_bool",3, ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
